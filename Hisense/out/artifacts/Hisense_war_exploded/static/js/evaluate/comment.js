jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: '/Hisense/static/image/evaluate/stars.jpg',
		imageAll :'/Hisense/static/image/evaluate/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	content.find('.rater-star-item').mouseover(function() {
		...
		var current_number	= jQuery(this).prevAll('.rater-star-item').length+1;/* .size()*/
